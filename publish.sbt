...
pomExtra := (
  <url>https://github.com/InnovaCo/binders-typesafe-config</url>
    <licenses>
      <license>
        <name>BSD-style</name>
    ...
    <scm>
      <url>git@github.com:InnovaCo/binders-typesafe-config.git</url>
      <connection>scm:git:git@github.com:InnovaCo/binders-typesafe-config.git</connection>
    </scm>
    <developers>
      <developer>
        <id>InnovaCo</id>
